...
var FakeLayer = function FakeLayer(_ref) {
  var children = _ref.children,
      ...
      rest = _objectWithoutPropertiesLoose(_ref, ["children", "dataTestid"]);
  ...
  if (showLayer) {
    layer = /*#__PURE__*/_react["default"].createElement(_.Layer, _extends({
...
describe('Layer', function () {
  ...
  var positions = ['top', 'bottom', 'left', 'right', 'start', 'end', 'center', 'top-left', 'top-right', 'bottom-left', 'bottom-right'];
  var fullOptions = [true, false, 'horizontal', 'vertical'];
  positions.forEach(function (position) {
    return fullOptions.forEach(function (full) {
      test("position: " + position + " - full: " + full, function () {
        ...
        (0, _portal.expectPortal)('position-full-test').toMatchSnapshot();
      });
    });
  });
  ...
  test('invoke onClickOutside when modal={true}', function () {
    ...
    (0, _portal.expectPortal)('layer-node').toMatchSnapshot();
  ...
  test('invoke onClickOutside when modal={false}', function () {
    var onClickOutside = jest.fn();
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.Grommet, null, /*#__PURE__*/_react["default"].createElement(FakeLayer, {
      id: "layer-node",
      onClickOutside: onClickOutside,
  ...
  test('invoke onClickOutside when modal={false} and layer has target', function () {
    var onClickOutside = jest.fn();
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(TargetLayer, {
      id: "target-test",
      onClickOutside: onClickOutside,
      modal: false
    }));
  ...
  test('invoke onClickOutside when modal={true} and layer has target', function () {
    var onClickOutside = jest.fn();
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(TargetLayer, {
      id: "target-test",
      onClickOutside: onClickOutside
